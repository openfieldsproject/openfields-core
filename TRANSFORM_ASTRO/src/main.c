...
#define OK_LAT     (1 << 1)
#define OK_LON     (1 << 2)
#define OK_ALL     (OK_EPOCH | OK_LAT | OK_LON)
...
void on_message(struct mosquitto *mosq, void *userdata, const struct mosquitto_message *msg)
{
  ...
  if (strcmp(msg->topic, "DATA/RTC/EPOCH") == 0)
  {
    data->epoch = atol((char *)msg->payload);
    data->ok_pub |= OK_EPOCH;
  }
  else if (strcmp(msg->topic, "DATA/GPS/LAT") == 0)
  {
    data->latitude = atof((char *)msg->payload);
    data->ok_pub |= OK_LAT;
  }
  else if (strcmp(msg->topic, "DATA/GPS/LON") == 0)
  {
...
int main()
{
    ...
    mosquitto_subscribe(mosq, NULL, "DATA/RTC/EPOCH", QOS);
    mosquitto_subscribe(mosq, NULL, "DATA/GPS/LAT", QOS);
    mosquitto_subscribe(mosq, NULL, "DATA/GPS/LON", QOS);
